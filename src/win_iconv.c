...
typedef int (*f_mbtowc)(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
typedef int (*f_wctomb)(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
typedef int (*f_mblen)(csconv_t *cv, const uchar *buf, size_t bufsize);
typedef int (*f_flush)(csconv_t *cv, uchar *buf, size_t bufsize);
...
static int sbcs_mblen(csconv_t *cv, const uchar *buf, size_t bufsize);
static int dbcs_mblen(csconv_t *cv, const uchar *buf, size_t bufsize);
static int mbcs_mblen(csconv_t *cv, const uchar *buf, size_t bufsize);
static int utf8_mblen(csconv_t *cv, const uchar *buf, size_t bufsize);
static int eucjp_mblen(csconv_t *cv, const uchar *buf, size_t bufsize);

static int kernel_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
static int kernel_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
static int mlang_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
static int mlang_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
static int utf16_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
static int utf16_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
static int utf32_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
static int utf32_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
static int iso2022jp_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize);
static int iso2022jp_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize);
static int iso2022jp_flush(csconv_t *cv, uchar *buf, size_t bufsize);
...
static int
sbcs_mblen(csconv_t *cv UNUSED, const uchar *buf UNUSED, size_t bufsize UNUSED)
{
  return 1;
}

static int
dbcs_mblen(csconv_t *cv, const uchar *buf, size_t bufsize)
{
...
static int
mbcs_mblen(csconv_t *cv, const uchar *buf, size_t bufsize)
{
  int len = 0;
...
static int
utf8_mblen(csconv_t *cv UNUSED, const uchar *buf, size_t bufsize)
{
  int len = 0;
...
static int
eucjp_mblen(csconv_t *cv UNUSED, const uchar *buf, size_t bufsize)
{
  if (buf[0] < 0x80) /* ASCII */
    return 1;
...
static int
kernel_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize)
{
  int len;
...
static int
kernel_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize)
{
  ...
  assert(bufsize < INT_MAX); // WideCharToMultiByte accepts int
                             // bufsize cast to int must be safe
  ...
  len = WideCharToMultiByte(cv->codepage, flags,
    (const wchar_t *)wbuf, wbufsize, (char *)buf, (int)bufsize, NULL, p);
  if (len == 0)
  {
 ...
 */
static int
mlang_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize)
{
  int len;
  int insize;
  HRESULT hr;
...
static int
mlang_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize)
{
...
static int
utf16_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize)
{
...
static int
utf16_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize)
{
  if ((cv->flags & FLAG_USE_BOM) && !(cv->mode & UNICODE_MODE_BOM_DONE))
  {
    int r;
...
static int
utf32_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize)
{
  int codepage = cv->codepage;
  uint wc = 0xD800;
...
static int
utf32_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize)
{
  uint wc;
...
enum iso2020jp_cs
{
  ISO2022JP_CS_UNDEF = -1,
  ISO2022JP_CS_ASCII = 0,
  ISO2022JP_CS_JISX0201_ROMAN = 1,
  ISO2022JP_CS_JISX0201_KANA = 2,
  ISO2022JP_CS_JISX0208_1978 = 3,
  ISO2022JP_CS_JISX0208_1983 = 4,
  ISO2022JP_CS_JISX0212 = 5
};
...
static int
iso2022jp_mbtowc(csconv_t *cv, const uchar *buf, size_t bufsize, ushort *wbuf, int *wbufsize)
{
...
static int
iso2022jp_wctomb(csconv_t *cv, ushort *wbuf, int wbufsize, uchar *buf, size_t bufsize)
{
  iso2022_esc_t *iesc = iso2022jp_esc;
  char tmp[MB_CHAR_MAX];
  int tmpsize = MB_CHAR_MAX;
...
static int
iso2022jp_flush(csconv_t *cv, uchar *buf, size_t bufsize)
{
  iso2022_esc_t *iesc = iso2022jp_esc;
  int esc_len;
